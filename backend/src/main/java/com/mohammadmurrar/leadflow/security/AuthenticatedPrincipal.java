...
public final class AuthenticatedPrincipal implements UserDetails, Serializable {
    ...
    private AuthenticatedPrincipal(UUID id, String email, String displayName, UserRole role, boolean enabled) {
        this(id, email, displayName, role, null, enabled);
    }

    public AuthenticatedPrincipal withoutCredentials() {
        return new AuthenticatedPrincipal(id, email, displayName, role, enabled);
    }
